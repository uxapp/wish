...
public class NowLayout extends LinearLayout implements OnGlobalLayoutListener {
	...
	private void initLayoutObserver() { // force vertical orientation and add
										// observer
										...
										// boolean inversed = false; final int
										// childCount = getChildCount(); for
										// (int i = 0; i < childCount; i++) {
										// View child = getChildAt(i); int[]
										// location = new int[2];
										...
										// R.anim.slide_up_left)); } else {
										// child.startAnimation(
										// AnimationUtils.loadAnimation(getContext(),
										// R.anim.slide_up_right)); } inversed =
										// !inversed; } }
	}
